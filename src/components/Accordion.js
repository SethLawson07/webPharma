...
export default function Acordion () {
    ...
    <Accordion.Item eventKey="0" class="bg-dark text-white " >
      ...
      <Accordion.Body>
      Le problème qu’on veut résoudre ce sont les pertes de temps inutiles dans la recherche d’une pharmacie
       ou d’un produit pharmaceutique
  
      </Accordion.Body>
    </Accordion.Item>  
    <Accordion.Item eventKey="1" class="bg-dark text-white">
      <Accordion.Header> <p className='fw-bold'>Qu'est-ce que nous faisons <Icon.ArrowDownSquareFill color="#008065"/></p> </Accordion.Header>
      <Accordion.Body>
